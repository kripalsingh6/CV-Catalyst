                 ...
                 {errors.name && (
                   ...
                   <p className="text-red-400 text-sm mt-1">
                    ...
                    <div>
                        ...
                        className="w-full px-4 py-3 bg-black/40 border border-gray-800 rounded-full text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"></input>
